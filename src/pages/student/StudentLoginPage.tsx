...
const quotes = [
  ...
  {
    text: "Aqoontu waa iftiin, akhriskuna waa fure. Your journey at Dhapti starts with excellence.",
...
export const StudentLoginPage = () => {
  ...
  const [email, setEmail] = useState("mohamudcade143@gmail.com");
  ...
  return (
    <div className="flex h-screen w-full flex-col overflow-hidden bg-[#050505] font-sans text-white md:flex-row">
      ...
      <div className="relative hidden flex-[1.2] flex-col justify-center overflow-hidden border-r border-white/5 bg-gradient-to-br from-black via-[#00152e]/60 to-black px-16 md:flex lg:px-24">
        <button
          onClick={() => navigate("/")}
          className="group absolute left-10 top-10 z-50 flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-white/40 hover:text-orange-500"
        >
        ...
        <div className="relative z-10 max-w-lg">
          ...
          >
            ...
            <h1 className="mb-10 text-4xl font-black leading-[1.1] tracking-tight lg:text-6xl">
              Build Your <br />
      ...
      <div className="relative flex min-h-0 flex-1 flex-col items-center justify-center overflow-y-auto bg-black px-6 py-12">
        ...
        >
          ...
          >
            ...
            >
              {submitting ? "Signing In…" : "Sign In Now"} <ShieldCheck size={18} />
            </button>
          </form>
          ...
          <div className="w-full border-t border-white/5 pt-4 text-center">
            <p className="text-[10px] font-bold uppercase tracking-wider text-gray-500">
              New Student?{" "}
              <span className="cursor-pointer font-black text-white underline decoration-orange-500/50 hover:text-orange-500">
                Apply Here
              </span>
            </p>
          </div>
